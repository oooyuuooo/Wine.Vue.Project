    ...
    <div class="register">
      <div class="left-side">
        <div class="left-info">
          ...
          <form>
            ...
            <input type="email" placeholder="信箱" v-model="memberInfo.email" />
            <input type="text" placeholder="電話" v-model="memberInfo.phone" />
            <input
              type="date"
              placeholder="生日"
      ...
      <div class="right-side">
        <div class="right-info">
          ...
          <span style="font-size: 18px; font-weight: bold">已經有帳號了?</span>
